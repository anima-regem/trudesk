...
class CardList extends React.Component {
  ...
  render() {
    ...
    return (
      <div
        className={'md-card-list-wrapper' + (extraClass ? ' ' + extraClass : '')}
        role="region"
      ...
      >
        <div className={'md-card-list'}>
          {header && (
            <div
              className={'md-card-list-header heading_list'}
              role="heading"
              aria-level="2"
            >
              {header}
          ...
          {headerRightComponent && (
            <div
              className={'md-card-list-header-right'}
              aria-hidden={!headerRightComponent}
            >
              {headerRightComponent}
            </div>
          )}
          <ul
            className={'hierarchical_slide'}
            data-delay='100ms'
            role="list"
            aria-label="Items"
          >
